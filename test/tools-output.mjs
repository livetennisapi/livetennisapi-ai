...
async function main() {
  ...
  // has_analysis / has_market (added 2026-09-02): present-true and present-false
  // reach the caller as booleans and as one summary line each ...
  ...
  // ... and absent (older server) is null, with no coverage line invented.
